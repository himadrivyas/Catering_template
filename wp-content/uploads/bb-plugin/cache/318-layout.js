...
var wpAjaxUrl='http://localhost/cathy/wp-admin/admin-ajax.php';var flBuilderUrl='http://localhost/cathy/wp-content/plugins/beaver-builder-lite-version/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://localhost/cathy/wp-content/plugins/beaver-builder-lite-version/',wpAjaxUrl:'http://localhost/cathy/wp-admin/admin-ajax.php'},breakpoints:{small:880,medium:1280},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
